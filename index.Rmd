---
title: "Mapa de conectividad de grupos funcionales de aves en otros hábitats en el cantón de La Unión"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos-conectividad/master/launion/otras/PROBABILIDAD_CONECTIVIDAD_OTRAS_LA_UNION_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_otras_la_union/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_otras_la_union/FeatureServer/0"

#--------------- Objetos sf y raster ---------------

# Límite del cantón de La Unión
sf_limite_launion <-
  esri2sf(url_agfs_limite_launion)

# Límite del cantón de La Unión (reproyectado a Web Mercator)
...
# Esencialidad
bins_esencialidad <- c(0, 0.02227, 0.06439, 0.12441, 0.23792, Inf)
...
leaflet() %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Límite de La Unión", "Probabilidad de conectividad", "Teselas esenciales", "Teselas importantes", "Rutas de conectividad"),
